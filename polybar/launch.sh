...
CONFIG_FILE="$HOME/.local/share/dwm-wattox/polybar/themes/$THEME/config.ini"
LAPTOP_CONFIG_FILE="$HOME/.local/share/dwm-wattox/polybar/themes/$THEME/laptop-config.ini"
